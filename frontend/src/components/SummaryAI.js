...
// const SummaryAI = ({paperTitle}) => {
//     const [summary, setSummary] = useState('');
//     const [loading, setLoading] = useState(false);
//     const [error, setError] = useState(' ');

//     useEffect(() => {
//         //reset states when paper title changes
//         setSummary('');
//         setError(' ');
//     }, [paperTitle]);
...
//             }
//         }catch(error){
//             console.error('Summary generatiom error:', error);
...
//     return(
//         <Box style={{ padding: '20px', backgroundColor: '#1e1e1e',color: "#ffffff", height: 'auto', display: 'flex', flexDirection: 'column', position: 'relative' ,alignTems: 'center'}}>
